...
def send_email(host: str = "localhost", port: int = 25, from_email: str = "test@localhost", to_email: str = "test@localhost", subject: str = "Heartrate Threshold!", message: str = "Test contents!"):
